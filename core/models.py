...
class Categoria(models.Model):
    descripcion_categoria = models.CharField(max_length=255, blank=False, default='Natural')
...
class MedioPago(models.Model):
    descripcion_medio = models.CharField(max_length=55, blank=False, default='Efectivo')
...
#     sku_producto = models.ForeignKey(Producto,on_delete=models.CASCADE, null=True, verbose_name=("Producto"))
#     id_medio = models.ForeignKey(MedioPago, on_delete=models.CASCADE,null=True, verbose_name=("Medio de Pago"))
